...
<head>
  ...
  <title>Fedad Mohamed Anis</title>
  <style>
    body {
      background-image: url('E:\wallpapers\1345733.png');
    ...
    h1, h2, p, h4 {
      text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8); /* Add a shadow for better text contrast */
    }
  </style>
</head>
<body>
  ...
  <h2 align="left">Languages & Technologies I Know💻:</h2>
